        ...
        >
          <div className="flex justify-start gap-3">
            {appliedTag.length > 0 ? (
                ...
                return (
                  <div
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      setAppliedTag(
                        appliedTag.filter((item) => item.tag !== tag)
                      );
                    }}
                  >
                    <FontAwesomeIcon
              ...
              <p className="text-dark-font-light font-semibold select-none">
                Choose your project tags
              </p>
            )}
          </div>
          <FontAwesomeIcon
            icon={popupDisplay ? faChevronDown : faChevronRight}
        ...
        <div className="ease-linear">
          {popupDisplay && (
            ...
            >
              ...
              />
              <div
                className={`h-8 w-8 bg-${selectedColor} rounded-full cursor-pointer relative transition-colors duration-200`}
                onClick={() => {
