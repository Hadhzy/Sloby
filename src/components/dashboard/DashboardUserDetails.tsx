    ...
    return (
        <div className='flex flex-col gap-10 p-8 ml-4 text-white'>
            ...
            <div className={"flex gap-20"}>
                <div>
                    <DashboardStats title={"Total visits"} subTitle={"Over the past 2 weeks"}
                                    valueEnd={"visits"} lightColor={"bg-blue-perfect"} darkColor={"bg-blurple"}
                                    chartData={totalVisits}
                    />
                </div>
                <div>
                    <DashboardStats title={"Hours spent using Sloby"} valueEnd={"hours"}
                ...
                <div className={"flex-center flex-col text-center rounded-large gap-4 font-bold w-80"}
                    ...
                    <p className='text-lg text-white/30'>Upgrade to unlock the full functionality of
                        Sloby</p>
                    <button
                        className={"bg-[#782588] rounded-full p-2 px-4 transition-transform ease-in-out hover:scale-110"}>Upgrade
                    </button>
                </div>
            </div>
            <p className={"text-5xl font-bold flex gap-36 underline decoration-dark-border underline-offset-8"}>Recent
                Projects</p>
            <div className={"flex gap-20"}>
