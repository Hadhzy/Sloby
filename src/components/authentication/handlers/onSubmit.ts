...
export async function onSubmit(
  event: React.FormEvent<HTMLFormElement>, emailStyles: string, setEmailStyles: Function, setPasswordStyles: Function, setErrorMsg: Function, setSuccessMsg: Function, emailRef: any, strength: any, passwordRef: any,usernameRef: any, supabase: any
  ) {
